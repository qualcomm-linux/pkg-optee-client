...
This is the debian packaging side of the optee-client for Mink:
Upstream project is hosted here : https://github.com/OP-TEE/optee_client
...
```
sudo dpkg -i libckqteec0_x_arm64.deb
```
## Usage
...
pkg-optee-client is licensed under the [BSD-3-clause License](https://spdx.org/licenses/BSD-3-Clause.html). See [LICENSE.txt](LICENSE.txt) for the full license text.
